  ...
  const discountCodes = [
    {
      ...
      code: "gbqdb76",
      description:
        "کد تخفیف هدیه به پشتیان فیتنو تا 75,000 تومان | اعتبار روی خرید من 2,400 تومان | اعتبار تا",
      type: "active",
    },
    {
      id: "2",
    ...
    },
    {
      ...
      code: "gbqdb76",
      description:
        "کد تخفیف هدیه به پشتیان فیتنو تا 75,000 تومان | اعتبار روی خرید men 2,400 تومان | اعتبار تا",
      type: "active",
    },
  ];
